...
function Get_Id_Info (Network_Device_Name : String) return Power_Line_Adapter.Id_Info_Type is
...
begin
   ...
   declare
      ...
      Id_Info : constant Power_Line_Adapter.Id_Info_Type := Adapters.First_Element.Get_Id_Info (Network_Device_Name => Network_Device_Name);
