...
function Get_Id_Info (Network_Device_Name : String;
                      PLA_MAC_Address     : MAC_Addresses.MAC_Address_Type) return Power_Line_Adapters.Id_Info_Type is
...
begin
   ...
   return Adapters.First_Element.Get_Id_Info (Network_Device_Name => Network_Device_Name);
